...
```{r}
fort <- st_read(
  "vw_Fortaleza_Bairros.shp", quiet = TRUE, options = "ENCODING=WINDOWS-1252")

fort_reg <- st_read(
  "fort_reg_pop_2010.shp", quiet = TRUE, options = "ENCODING=WINDOWS-1252")
...
"pop_fort_2010.shp", quiet = TRUE, options = "ENCODING=WINDOWS-1252")
...
```{r}
fort_reg_pop <- st_read("fort_reg_pop_2010.shp", quiet = TRUE, options = "ENCODING=WINDOWS-1252")
...
#vias_class <- read_sf("vw_ClassificacaoLogradouros.shp", quiet = TRUE, options = "ENCODING=UTF-8")
...
vias_fort <- st_read(
  "vw_ViasArteriais.shp", quiet = TRUE, options = "ENCODING=WINDOWS-1252")
...
dat <- read_excel("sinistros_fortaleza_atualizado_19Jul2024.xlsx")
...
```{r}
dat_geo <- read_xlsx("dat_geo_atualizado_01Jun2024.xlsx")
```
...
imp <- read_excel("ReadequacaoVelocidade_Vias_atual_24Mar24.xlsx")
```
...
vitimas_dat <- read_excel("sinistros_fortaleza_atualizado_29Jul2024_vitimas.xlsx")
...
veic_dat <- read_xlsx("sinistros_fortaleza_atualizado_23Jun2024_veiculos.xlsx")
```
...
```{r}
vias_dat <- read_excel("sinistros_fortaleza_atualizado_24Jun2024_vias.xlsx")
